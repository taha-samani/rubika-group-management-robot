...
**-سپس گوید گروه های خود را در قسمت `guids` در فایل `bot.py` زده سپس سیو کرده و فایل را ببندید **

**-پوشه را زیپ کنید و ان را در هاست لیارا در  بخش برنامه داکر مستقر کنید**
...
#### متن زیر را ارسال کنید و بعد ان یک فاصله بعد کلمه یا جمله ای که دیکشنری ربات دیدید وارت کنید دقیقا به حالت خودش که در دیکشنری وجود دارد تا ان از دیکشنری پاک شود(مثال برای حذف کلمه که در دستور یادبگیر اولش داشت تایپ می کنیم  : `حذف کن سلام ربات`)
